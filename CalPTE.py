...
def plot_data(pos_s, para_s, labeled_index=None, atomnames=None, auto_colorscale=False, cmin=0, cmax=0,
              filter=None,
    ...
    if atomnames is None:
        atomnames = ['cAl', 'sO', 'sAl', 'eO']
    colors_dic = {'cAl': 'silver', 'sO': 'red', 'sAl': 'black', 'eO': 'green', 'H': 'white', 'wO': 'pink'}
    fontsize = 11
